...
def TodoView(request):
    ...
    template_value = {
        'todolist': todolist, 'finishedlist': finishedlist, 'username': username}
...
def AddView(request):
    ...
    if request.method == "POST":
        ...
        todo = Todo(
            user=username, todo=thisTodo, priority=thisPriority, flag=1)
        todo.save()
...
def EditView(request, id=''):
    ...
    #     return render_to_response(template_name, template_value, context_instance=RequestContext(request))
        ...
        try:
            ...
            raise Http404
        return render_to_response(template_name, template_value,
